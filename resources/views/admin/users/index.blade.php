                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Danh sách tài khoản</h5>
                        </div>
                        <ul class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="card table-card">
                <div class="card-header">
                    <h5>Bảnh danh sách tài khoản</h5>
                                        ...
                                        <td>
                                            <div class="role">
                                                @foreach($value->roles as $role)
                                                    @if($role->id == 1)
                                                        <span class="pcoded-badge badge bg-success" data-id="{{$value->id}}">
                                                            {{ $role->name }}
                                                        </span>
                                                    @else
                                                        <span class="pcoded-badge badge bg-danger" data-id="{{$value->id}}">
                                                            {{ $role->name }}
                                                        </span>
                                                    @endif
                                                @endforeach
...
{{$value->created_at}}
                                        ...
                                        <td>
                                            <a href="{{route('users.changeRole', ['id' => $value->id])}}">
                                                <i class="icon feather icon-edit f-16 text-c-green"></i>
                                            </a>
                                        </td>

                                        {{-- <td>
                                            <a href="{{route('status_order.edit',['id'=>$value->id])}}">
                                                <i class="icon feather icon-edit f-16  text-c-green"></i>
                                            </a>
                                            <a href="#" data-url="{{route('status_order.delete',['id'=>$value->id])}}" class="action_delete_status">
