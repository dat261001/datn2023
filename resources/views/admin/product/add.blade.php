...
$(document).ready(function() {
  $('#mfu-new-item-btn').click(function(){
    $('#file-con').append("<input class='mfu-file-input form-control mb-1 mt-1' type='file' name='files[]' >");
  })
  $('#mfu-new-item-btn1').click(function(){
    $('#file-con1').append("<input class='mfu-file-input form-control mb-1 mt-1' type='text' name='infor[]' >");
  })
});
