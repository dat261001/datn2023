...
@section('title')
    <title>Sửa sản phẩm {{ $data->name }}</title>
@endsection
    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('product.edit', ["id" => $data->id])}}">Sửa sản phẩm {{ $data->name }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <h5 class="mt-5">{{ $data->name }}</h5>
                        <hr>
                        <form action="{{route('product.edit', ["id" => $data->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $data->name_file }}" name='name_file' class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $data->keywords }}" name='keywords' class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="validationTextarea" class="form-label">Mô tả : </label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="des" id="validationTextarea" placeholder="Tóm tắt nội dung trang web" required="">{{ $data->des }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $data->quantity }}" name='quantity' class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="inputEmail3" class="col-sm-3">Trạng Thái</label>
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $data->type }}" name='type' class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="inputEmail3" class="col-sm-3">Hot</label>
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $data->hot }}" name='hot' class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="inputEmail3" class="col-sm-3">Giá Bán</label>
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $data->price }}" name='price' class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="inputEmail3" class="col-sm-3">Giá Sau Giảm</label>
                                <div class="col-sm-9">
                                    <input type="text" value="{{ $data->sale_product }}" name='sale_product' class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="inputEmail3"  class="col-sm-3">Giảm Giá</label>
                                <div class="col-sm-9">
                                    <input type="number" value="{{ $data->discount }}" onkeyup="checkNumber()" name='discount' class="form-control" id="inputDiscount">
                                </div>
                                <label for="inputEmail3" class="col-sm-3">Hạn Giảm Giá</label>
                                <div class="col-sm-9">
                                    <input type="date" value="{{ $data->sale_time }}" name='sale_time' class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="input-group mb-3">
                                    <label class="input-group-text" for="inputGroupFile01">Ảnh chính của sản phẩm</label>
                                    <input type="file" value="{{ $data->file }}" name="file" class="form-control" id="inputGroupFile01">
                                    <div>
                                        <img width="200" src="{{asset('assets/upload/'.$data->main_img)}}">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <textarea class="form-control" rows="5" name="review" id="content">
                        {{ $data->review }}
                    </textarea>
                </div>
            </div>
