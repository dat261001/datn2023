                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Trạng thái đơn hàng</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('index')}}"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Trạng thái đơn hàng</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card table-card">
                <div class="card-header">
                    <h5>Bảnh danh sách trạng thái</h5>
...
{{$value->name}}
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('status_order.delete',['id'=>$value->id])}}" data-url=""  onclick="if (confirm('Xóa lựa chọn này.')){return true;}else{event.stopPropagation(); event.preventDefault();};" >
