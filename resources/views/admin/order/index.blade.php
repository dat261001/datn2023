                            ...
                            <table class="table table-hover m-b-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="shiper" onchange="change('{{$value->id}}', this)" class="form-select">
                                                @if(empty($value->shiper))
                                                    <option value="0">
                                                        Chưa chọn
                                                    </option>
                                                    @foreach($shipers as $ship)
                                                ...
                                                @else
                                                    ...
                                                    @foreach($shipers as $ship)
                                                        @if($ship->id == $value->shiper_id)
                                                            <option selected value="{{$ship->id}}">
                                                                {{$ship->name}}
                                                            </option>
                                                        @else
                                                            <option value="{{$ship->id}}">
...
@endif
<script type="text/javascript">
    function change(id, ship) {
        console.log(id )
        console.log(ship.value)
        fetch('http://127.0.0.1:8000/admin/order/change_ship?id=' + id + '&ship_id=' + ship.value)
