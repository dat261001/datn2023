                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Danh sách đơn hàng đang giao</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('index')}}"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Danh sách đơn hàng đang giao</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card table-card">
                <div class="card-header">
                    <h5>Bảnh Danh sách đơn hàng đang giao</h5>
...
<td>{{$value->money}} VNĐ</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('order.done',['id'=>$value->id])}}">
                                                <i class="fas fa-check check"></i> Đã nhận hàng
                                            </a>
