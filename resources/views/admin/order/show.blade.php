                ...
                <div class="">
                    <div class="card-body">
                        <div class="">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2" style="padding-left: 48px;">Money:</label>
                                <div class="col-lg-8">
                                    <input class="form-control" type="text" value="{{$data->money}} VNĐ" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2" style="padding-left: 48px;">Status:</label>
                                <div class="col-lg-8">
                                    <input class="form-control" type="text" value="{{$data->status->name}}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2" style="padding-left: 48px;">Đơn vị chuyển:</label>
                                <div class="col-lg-8">
                                    @if(isset($data->shiper))
                                        <input class="form-control" type="text" value="{{$data->shiper->name}}" readonly>
                                    @else
                                        <input class="form-control" type="text" value="Chưa chọn" readonly>
                                    @endif
                                </div>
                            </div>
<div>
