...
@section('title')
<title>Sửa đơn vị vận chuyển</title>
@endsection
    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Sửa đơn vị vận chuyển</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item"><a href="{{route('categories.add')}}">Sửa đơn vị vận chuyển</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <h5 class="mt-5">Sửa đơn vị vận chuyển</h5>
                        <hr>
                        <form action="{{route('shiper.edit',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="inputEmail3" class="col-sm-3">Đơn vị vận chuyển : </label>
                                <div class="col-sm-9">
                                    <input type="text" name='name' value="{{$data->name}}" required class="form-control" id="inputEmail3">
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="col-sm-9">
                                    <img class="img-n" style="width:150px;margin: 5px;border-radius: 5px;" src="{{asset('assets/upload/'.$data->img)}}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name='phone' value="{{$data->phone}}" required class="form-control" id="inputEmail3">
                                </div>
                            </div>
