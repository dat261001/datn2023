                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Danh sách Hình thức thanh toán</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('index')}}"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Danh sách Hình thức thanh toán</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card table-card">
                <div class="card-header">
                    <h5>Bảnh danh sách Hình thức thanh toán</h5>
...
{{$value->created_at}}
                                        ...
                                        <td>
                                            <a href="{{route('pay.edit',['id'=>$value->id])}}">
                                                <i class="icon feather icon-edit f-16  text-c-green"></i>
                                            </a>
                                            <a href="{{route('pay.delete',['id'=>$value->id])}}"  onclick="if(confirm('Xóa lựa chọn này.')){return true;}else{event.stopPropagation(); event.preventDefault();};" class="">
