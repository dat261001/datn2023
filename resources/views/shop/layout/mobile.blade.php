    ...
    <div class="featured__phone__product__list">
        ...
        @foreach ($mobile as $value)
            <div class="featured__phone__product__item">
                ...
                @if ($value->discount && $value->discount->sale != 0)
                    <div class="flash__sale__discount">
                        <p>Giảm {{ $value->discount && $value->discount->sale }}%</p>
                    </div>
                @endif
                @if ($value->discount && $value->discount->sale >= 15)
                    <div class="hot__sale">
                ...
                <div class="featured__phone__product__desc">
                    ...
                    <button class="action-button button-red cta-mua-ngay" onclick="addToCart()"><strong>MUA NGAY</strong></button>
                </form> --}}
    ...
    <div class="featured__phone__product__list">
        @foreach ($mobile1 as $value)
            <div class="featured__phone__product__item">
                ...
                @endif
                <div class="featured__phone__product__img__wrapper">
                    <a href="{{route('pro',['file'=>$value->category->file,'name'=>$value->name_file])}}"><img src="{{ asset('assets/upload/' . $value->main_img) }}"
                            alt="{{ $value->name }}"></a>
                </div>
                <div class="featured__phone__product__desc">
                    <div class="featured__phone__product__desc__title">
