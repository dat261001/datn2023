function search_product(){
    ...
    fetch('http://127.0.0.1:8000/get_item/'+key,{
        method: "get",
        headers: {
    ...
    .then(data => {
        ...
        data.forEach((d) => {
            ...
            html += `
                    <li>
                        <a href="http://127.0.0.1:8000/`+d.file +`/` +d.name_file +`" class="w100 mb-5 flex">
                            <div>
                                <img class="img-se" src="http://127.0.0.1:8000/assets/upload/`+d.main_img+`">
                            </div>
                            <div class="pm">
                                <div>
                                    <p class="p1">
