...
Route::post('login',[LoginAdminController::class, 'check'])->name("login");
...
Route::group(['prefix'=>'/admin'],function(){
    ...
    Route::group(['prefix'=>'order'],function(){
        Route::controller(OrderController::class)->group(function () {
            ...
            Route::get('change_ship',[
                'as'=>'order.change_ship',
                'uses'=>'change_ship',
            ]);
...
Route::post('/addToCart', [ShopController::class, 'store']);
